...
const githubRegisterLogin = `https://github.com/login/oauth/authorize?client_id=${GITHUB_CLIENT_ID}&redirect_uri=${GITHUB_REGISTER_REDIRECT_URI}&response_type=code&scope=user`;
