...
function UserInfoView({
    ...
    if (type === 'join' || type === 'password') {
      return (
        <>
          ...
          <SubTitle>
            {type === 'join'
              ? t('join.subtitle.password')
              : t('mypage.passwordChange.changePwd')}
          </SubTitle>
          <InputForm
            {...register('password', {
              required: `${t('join.validate.required')}`,
            ...
            {...register('passwordCheck', {
              ...
              validate: {
                matchesPreviousPassword: (val) => {
                  ...
                  return (
                    val === password || `${t('join.validate.passwordCheck')}`
                  );
                },
              },
            })}
  ...
  return (
    <>
          ...
          <JoinForm onSubmit={handleSubmit(onSubmit, onInValid)}>
            {type === 'password' || (
              <>
                ...
                <LoginJoinBtn>
                  {type === 'join'
                    ? t('join.button.signup')
                    : t('mypage.account.button')}
                </LoginJoinBtn>
              </>
            )}
            {type === 'password' && (
      ...
      {isPostModal && (
        <>
          <Modal visible={true} maskClosable={true} onClose={onPostModalClick}>
