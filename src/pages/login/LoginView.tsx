import { GOOGLE_CLIENT_ID } from "@api/apiKey"
import { InputForm, LoginJoinBtn } from "@styles/common.style"
import { EasyLogin, EasyLoginList, EasyLoginWrapper, Github, Google, Hr, KaKao, LoginForm, LoginWrapper, SubItem, SubList, Title } from "@styles/login.style"
...
interface ILoginViewProps {
  ...
  onGoogleFail: (error: any) => void;
}

function LoginView ({onSubmit, moveToJoin, onKakaoLogin, onGoogleSuccess, onGoogleFail}:ILoginViewProps) {
